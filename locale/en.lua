...
TOOLTIP = "Tooltip"
GENERAL_OPTIONS = "Configure the core XRP options, dealing with viewing, display, and caching. Note that some of these options may require a UI reload (/reload) to fully enable/disable in some cases."
