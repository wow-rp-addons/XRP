...
XRP_OPTIONS_CORE_MINIMAP_HIDETT = L["Hide status tooltip on minimap icon"]
XRP_OPTIONS_CORE_MINIMAP_DETACHED = L["Detach minimap icon from minimap (Shift + right click and drag to move)"]
...
XRP_OPTIONS_CORE_INTEGRATION_RIGHTCLICK_INSTANCE = L["Disable rightclick integration in instances"]
...
if (select(4, GetAddOnInfo("xrp_tooltip"))) then
	...
	XRP_OPTIONS_TOOLTIP_GUILDINDEX = L["Show guild rank number"]
	XRP_OPTIONS_TOOLTIP_NORPRACE = L["Hide roleplaying race"]
	XRP_OPTIONS_TOOLTIP_NORPCLASS = L["Hide roleplaying class"]
	XRP_OPTIONS_TOOLTIP_NOOPFACTION = L["Hide roleplaying information for opposite faction"]
