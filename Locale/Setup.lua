...
BINDING_NAME_XRP_ARCHIVE = L.TOGGLE_ARCHIVE
BINDING_NAME_XRP_EDITOR = L.TOGGLE_EDITOR
BINDING_NAME_XRP_STATUS = L.TOGGLE_STATUS
BINDING_NAME_XRP_VIEWER = L.VIEW_TARGET_MOUSEOVER
BINDING_NAME_XRP_VIEWER_TARGET = L.VIEW_TARGET
BINDING_NAME_XRP_VIEWER_MOUSEOVER = L.VIEW_MOUSEOVER
